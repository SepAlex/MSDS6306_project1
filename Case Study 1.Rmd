...
Our research will involve investigating and collating two datasets, the first containing a list of 2410 US craft beers and the second containing 558 US breweries. The two datasets are read using the R software prior to analysis. We assigned the Beers dataset to an object 'beers,' and the Breweries dataset to an object 'breweries. 
```{r breweries}
